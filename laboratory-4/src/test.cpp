...
int main(int argc, char **argv)
{
    ...
    static const std::string PLANNING_GROUP = "group1"; /* Now we specify with what group we want work, here group1 is the name of my group controller*/
    ...
    target_pose.pose.position.x = target_pose.pose.position.x - 0.1; /* Basically our target pose is the same as current, except that we want to move it a little bit along x-axis*/
